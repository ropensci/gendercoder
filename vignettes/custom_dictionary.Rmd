...
intersex are recoded to "Other". In some contexts researchers may wish to 
use narrow recoding but overwrite this particular behaviour so that individuals 
who report they are coded as intersex but the other entries in the dictionary are 
preserved.^[The package authors wish to acknowledge that the narrow categories 
make opionated assumptions and that the broad recoding will generally 
be more appropriate.]
