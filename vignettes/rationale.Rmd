...
The `fill` argument is used to determine the handling for recoding of values
...
- With narrow coding, intersex responses are recoded as 'sex and gender
diverse'
- With narrow coding, responses of people who indicate they are trans plus 
their gender are recoded as the identified gender (e.g. 'Male to Female' is 
recoded as Female). We wish to acknowledge that this may not reflect how some 
individuals would classify themselves when given these categories; in some 
contexts this recoding may make systematic errors. The broad coding dictionary 
attempts to avoid these issues as much as possible; however users can provide a 
custom dictionary to add to or overwrite our coding decisions if they feel
this is more appropriate. We welcome contributions to update the inbuilt
