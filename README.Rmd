...
while mantaining the diversity of responces. This is selected by setting 
...
human code-able (e.g. "I am male") or otherwise meaningful and not caputured by 
our base dictionary. We expect that researchers may wish to manually recode 
such responses or add frequently occuring responses to their custom dictionary.
